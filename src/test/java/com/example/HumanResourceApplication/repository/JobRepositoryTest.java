...
public class JobRepositoryTest {
    ...
    void testFindByMinSalaryGreaterThanEqual() {
        var list = repository.findByMinSalaryGreaterThanEqual(4000.0);
        assertThat(list).isNotEmpty();
    }

    @Test
    void testFindByMaxSalaryLessThanEqual() {
        var list = repository.findByMaxSalaryLessThanEqual(10000.0);
        assertThat(list).isNotEmpty();
    }

    @Test
    void testFindBySalaryRange() {
        var list = repository.findByMinSalaryBetween(4000.0, 10000.0);
        assertThat(list).isNotEmpty();
    }
